...
function GuestCreateGame({ changeState, changeGameRoomIDApp }) {
        ...
        <div className='options-game'>
          <div className='inner-box-game-creation'>
            <div className="j-box">
              ...
              <button style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }} onClick={() => changeState('home')} className="create-game-button">
                Home
              </button>
...
export default GuestCreateGame;